 ...
 * [MRIO.yml](MRIO.yml)
     * Determines how your purl.obolibrary.org/obo/MRIO/ redirects will be handled
     ...
     * Paste in the contents of [MRIO.yml](MRIO.yml)
 ...
 * [MRIO.md](MRIO.md)
     ...
     * Paste in the contents of [MRIO.md](MRIO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
